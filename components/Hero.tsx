  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden" style={{ background: '#000000' }}>
      ...
      <img
        src="/image/hero.png"
        alt=""
        className="absolute inset-0 w-full h-full object-cover object-right hidden sm:block"
        aria-hidden="true"
      />

      {/* Mobile: radial glow (original) */}
      <div
        className="absolute inset-0 pointer-events-none sm:hidden"
        style={{ background: 'radial-gradient(ellipse 80% 60% at 50% 50%, rgba(230,48,34,0.08) 0%, transparent 70%)' }}
      />
      <div
        className="absolute inset-0 opacity-[0.03] pointer-events-none sm:hidden"
        style={{
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(to right, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.65) 45%, rgba(0,0,0,0.10) 75%, transparent 100%)',
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-8 py-24">
        <div className="max-w-xl mx-auto sm:mx-0 text-center sm:text-left">
          ...
          <img
            ...
            style={{ maxHeight: '140px', objectFit: 'contain', filter: 'invert(1) brightness(1.1)' }}
          />
